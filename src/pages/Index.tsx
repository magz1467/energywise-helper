              ...
              <NavigationMenuItem>
                ...
                <NavigationMenuContent>
                  <div className="grid gap-3 p-6 w-[400px]">
                    ...
                    <div className="text-sm text-muted-foreground">Track and optimize your home energy usage</div>
                    <div className="font-medium">Smart Automation</div>
                    <div className="text-sm text-muted-foreground">Automate your energy savings with AI</div>
                  </div>
                </NavigationMenuContent>
              </NavigationMenuItem>
              <NavigationMenuItem>
                ...
                <NavigationMenuContent>
                  <div className="grid gap-3 p-6 w-[400px]">
                    ...
                    <div className="text-sm text-muted-foreground">Common questions about our service</div>
                    <div className="font-medium">About Us</div>
                    <div className="text-sm text-muted-foreground">Meet our team of experts</div>
                  </div>
                </NavigationMenuContent>
              </NavigationMenuItem>
            </NavigationMenuList>
